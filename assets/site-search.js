(() => {
  const entries = [
    ...
    { title: "Intake Discipline", url: "/governance/guides/intake-discipline.html", type: "Guide", summary: "Practical guidance for making portfolio demand ready for a real decision.", keywords: "intake demand governance pmo prioritization" },
    { title: "Portfolio Sequencing", url: "/governance/guides/portfolio-sequencing.html", type: "Guide", summary: "Sequencing work against capacity, dependencies, timing, and decision rights.", keywords: "portfolio manager sequencing capacity dependencies" },
    { title: "Executive Decision Support", url: "/governance/guides/executive-decision-support.html", type: "Guide", summary: "Making executive reviews decision-ready rather than status-heavy.", keywords: "executive decision support governance cadence" },
    { title: "Release Readiness and UAT", url: "/governance/guides/release-readiness-uat.html", type: "Guide", summary: "Evidence-based readiness, UAT, launch control, and exception handling.", keywords: "release readiness uat project manager delivery" },
    { title: "Value Realization", url: "/governance/guides/value-realization.html", type: "Guide", summary: "Turning delivery completion into owned, measured value realization.", keywords: "value realization benefits delivery portfolio" },
    { title: "Partner Ecosystem Governance Guide", url: "/governance/guides/partner-ecosystem-governance.html", type: "Guide", summary: "Governance for partner, provider, vendor, and external delivery ecosystems.", keywords: "partner vendor ecosystem governance" },
    { title: "AI Resource Allocation Governance", url: "/governance/guides/ai-resource-allocation-governance.html", type: "Guide", summary: "Keeping AI experiments connected to business value, risk, ownership, and measurement.", keywords: "ai resource allocation governance value risk" },
